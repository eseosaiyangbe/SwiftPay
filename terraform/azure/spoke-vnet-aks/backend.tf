...
terraform {
  backend "azurerm" {
    ...
    resource_group_name  = "swiftpay-tfstate-rg"      # Resource group for storage account
    storage_account_name = "swiftpaytfstate5c1c3f34"    # Replace ACCOUNT; run bootstrap first
